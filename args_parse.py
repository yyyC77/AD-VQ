...
def args_parser():
    ...
    # VQ
    parser.add_argument("--num_ec", default=2000, type=int)
    parser.add_argument("--num_es", default=2000, type=int)
    parser.add_argument("--commitment_weight", default=0.1, type=float)
    parser.add_argument("--cmt_w1", default=0.1, type=float)
    parser.add_argument("--cmt_w2", default=0.1, type=float)
    parser.add_argument('--info_w', default=0.01,type=float)

    # Encoder
    parser.add_argument("--emb_dim", default=128, type=int)
    parser.add_argument("--layer", default=4, type=int)
    parser.add_argument("--dropout", default=0.5, type=float)
    parser.add_argument("--gnn_type", default='gin', type=str, choices=['gcn', 'gin','gat','GraphSAGE'])
    ...
    parser.add_argument("--alpha_init", default=0.2, type=float)
    parser.add_argument("--anneal_epochs", default=80, type=int,
                        help="Number of epochs to anneal alpha.")
